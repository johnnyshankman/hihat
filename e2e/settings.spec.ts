...
test.describe('Settings', () => {
  ...
  test('should manage library folders', async () => {
    ...
    const folders = await page
      .locator('[data-testid^="library-folder-"]')
      .count();
  ...
  test('should configure audio settings', async () => {
    ...
    const gaplessToggle = await page.locator(
      '[data-testid="gapless-playback-toggle"]',
    );
    ...
    const crossfadeSlider = await page.locator(
  ...
  test('should clear cache', async () => {
    ...
    const confirmDialog = await page.locator(
      '[data-testid="confirm-clear-cache-dialog"]',
    );
